...
all: argParserTest qqNormTest SparseMatrixTest geneTopsTest rankTest fetch_batchTest FiltrationTest read10xTest mergeH5Test logNormalizeTest appTest createGeneTemplateTest geneFilterTest write2CSVTest transposeTest merge2csvTest moveTest
...
merge2csvTest:tests/merge2csv_t.cpp SparseMatrix.o lib/qqNorm/qqNorm.o lib/argparser/argparser.o lib/cell/cell.o lib/fun/fun.o
