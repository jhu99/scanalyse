...
parser.add_argument('--algorithm','-a', required= True, 
					...
					help='The optimization algorithms. It has two options, \'adam\' or \'rmsprop\'.')
...
if args.task =='train':
	train.train_model(input_file=args.input_file, output_file=args.output_file,optimizer=args.algorithm,format_type=args.format)
